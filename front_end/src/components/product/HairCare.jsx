...
const HairCarePage = () => {
  ...
  const hairCareCategories = [
    ...
    { id: "oil", name: "Hair Oils" },
    { id: "mask", name: "Hair Masks" }
  ];
    ...
    const fetchProducts = async () => {
      try {
        ...
        const formattedProducts = data.map(product => ({
          ...
          category: product.subcategory?.toLowerCase() || "other", // Use subcategory as category
          ...
          size: "250ml", // You can adjust this as needed
      ...
      <div className="relative">
        <div className="bg-gradient-to-r from-[#ffffff] to-[#fff5f6] py-16 px-4 md:px-8">
          <div className="max-w-6xl mx-auto">
            <h1 className="text-3xl md:text-5xl font-bold text-gray-800 mb-3">Luxury Hair Care</h1>
            <p className="text-gray-600 mb-6 md:w-2/3 lg:w-1/2 text-lg">
              Discover our collection of premium hair care products crafted to nourish, strengthen, and beautify your hair.
            </p>
      ...
      <div className="bg-white py-8 px-4 md:px-8 border-b border-gray-200">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-wrap items-center justify-between mb-4">
            <h2 className="text-2xl font-bold text-gray-800">Hair Care Collection</h2>
            <button 
          ...
          <>
            {filteredProducts.length === 0 ? (
              <div className="text-center py-12">
                <h3 className="text-xl text-gray-700 mb-4">No hair care products match your current filters</h3>
                <button 
                  onClick={() => {
                ...
                {filteredProducts.map(product => (
                  <div key={product.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 group">
                    <div className="relative overflow-hidden">
                      <img 
                        src={getImageUrl(product.image) || "/api/placeholder/300/300"} 
                        alt={product.name} 
