...
const Product = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      setIsLoading(true);
      try {
        const response = await fetch(`${API_BASE_URL}/api/products/category/product`);
        if (!response.ok) {
        ...
        const formattedProducts = data.map(product => ({
          ...
          description: product.details || product.description || "Premium quality product",
      ...
      <div className="bg-gray-50">
        ...
        <div className="bg-white py-8 px-4 md:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-2">ALL PRODUCTS</h2>
